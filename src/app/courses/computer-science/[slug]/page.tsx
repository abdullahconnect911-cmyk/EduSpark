...
export default function CSCourseDetailPage({ params }: { params: { slug: string } }) {
  ...
  const levelBadgeColor = course.level === 'Bachelor'
  ...
  return (
    <>
      <style>{`
        ...
        .cd-hero-title { font-size: clamp(1.2rem, 3vw, 1.9rem); font-weight: 900; color: #fff; font-family: var(--font-head); margin: 0 0 8px; line-height: 1.2; }
        ...
        .cd-card-title { font-size: 1rem; font-weight: 800; color: var(--blue); margin: 0 0 16px; padding-bottom: 12px; border-bottom: 1.5px solid #eef2fb; }
        ...
        .cd-apply-btn:hover { background: #e06a00; transform: translateY(-2px); }
          ...
          <div className="cd-hero-inner">
            ...
            <div>
              ...
              <div className="cd-hero-badges">
                ...
                <span style={{ background: levelBadgeColor.bg, color: levelBadgeColor.color, border: 'none', borderRadius: '20px', padding: '4px 12px', fontSize: '0.72rem', fontWeight: 700 }}>🎓 {course.level}</span>
                <span className="cd-badge">🔬 {course.specialization}</span>
                <span className="cd-badge" style={{ background: 'rgba(34,197,94,0.15)', borderColor: 'rgba(34,197,94,0.3)', color: '#86efac' }}>✓ Free Offer Letter</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="cd-page">
        <div className="cd-container">
          <div className="cd-layout">
              ...
              {course.scholarshipInfo && (
                <div className="cd-card">
                  ...
                  <div style={{ marginTop: '16px', padding: '14px 16px', background: '#f0f9ff', borderRadius: '10px', border: '1px solid #bae6fd' }}>
                    ...
                    <div style={{ fontSize: '0.8rem', color: '#0c4a6e', lineHeight: 1.6 }}>Our advisors identify every scholarship you qualify for and guide your complete application — at no extra cost.</div>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="cd-sidebar">
              ...
              <div className="cd-info-card">
                ...
                <a href={`https://wa.me/8801867778759?text=Hi, I'm interested in ${course.title} at ${course.university}. Can you help me apply?`}
                  target="_blank" rel="noopener noreferrer" className="cd-wa-btn">💬 WhatsApp Us</a>
              </div>
              ...
              {course.scholarshipInfo && (
                <div className="cd-scholarship-card">
                  ...
                  <p className="cd-scholarship-text">
                    {course.scholarshipInfo.slice(0, 120)}...{' '}
          ...
          <div style={{ marginTop: '32px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            <Link href="/courses/computer-science" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: 'var(--blue)', fontWeight: 600, fontSize: '0.85rem', textDecoration: 'none', border: '1.5px solid var(--border)', borderRadius: '8px', padding: '8px 16px', background: '#fff' }}>
              ← Back to CS & IT Courses
            </Link>
