    ...
    <>
      <div className="dash-header">
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          <Link href="/dashboard/admin/leads" className="btn-orange" style={{ fontSize: '0.875rem', padding: '10px 20px' }}>
            + New Lead
          </Link>
          <Link href="/dashboard/admin/applications" className="btn-blue" style={{ fontSize: '0.875rem', padding: '10px 20px' }}>
            View Applications
          </Link>
        </div>
      </div>
      ...
      <div className="dash-grid-2">
        ...
        <div className="dash-card">
          <div className="dash-card-header">
            ...
            <Link href="/dashboard/admin/applications" className="dash-card-action">Manage →</Link>
          </div>
        ...
        <div>
          <div className="dash-card" style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
              {[
                { href: '/dashboard/admin/users', icon: '👥', label: 'Manage Students', color: 'var(--blue-light)', textColor: 'var(--blue)' },
                { href: '/dashboard/admin/applications', icon: '📋', label: 'Review Applications', color: 'var(--orange-lt)', textColor: 'var(--orange2)' },
                { href: '/dashboard/admin/leads', icon: '🎯', label: 'Follow Up Leads', color: '#f0fdf4', textColor: '#166534' },
                { href: '/dashboard/admin/settings', icon: '⚙️', label: 'Settings', color: 'var(--off)', textColor: 'var(--text)' },
              ].map((a, i) => (
